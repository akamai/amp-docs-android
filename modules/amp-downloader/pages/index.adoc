...
_Start Download:_ Perhaps the main option available for this feature, it starts the download action for a specific stream:
...
_name:_ You need to provide a unique name for the stream, this is for an easy to use control of the downloader videos, as well as a more user friendly notification.
...
If you have further questions or comments, reach out to us via: https://player.akamai.com/support[https://player.akamai.com/support]
